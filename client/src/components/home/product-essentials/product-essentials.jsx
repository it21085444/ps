...
import productsData from "./product-essentials.json";
import "./product-essentials.css";
          ...
          <div className="bottom-div px-3 pt-3">
            <div className="flex items-center mt-2.5 mb-2 select-none">
              <div className="flex items-center space-x-1 rtl:space-x-reverse">
                ...
                <span className="bg-rose-100 text-rose-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-rose-200 dark:text-rose-800 ms-3">
