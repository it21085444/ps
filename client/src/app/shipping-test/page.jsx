    ...
    <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-4 md:order-3 lg:order-1">
          ...
          <div className="w-full border-b-2 bg-transparent duration-300 mb-8"></div>
        ...
        <div>
          ...
          {/* Add other input fields for first name, last name, email, phone, etc. */}
          <div className="flex flex-col mb-4">
            <input
              type="text"
              id="your_name"
        ...
        {/* Second Column */}
        <div>
          {/* Include remaining input fields */}
        </div>
      </div>
